package com.matterhornlegal.camera.internal;
...
import com.matterhornlegal.camera.ICallback;
import com.matterhornlegal.camera.util.CameraUtil;
import com.matterhornlegal.camera.util.Degrees;
import com.matterhornlegal.camera.util.ImageUtil;
import com.matterhornlegal.camera.util.ManufacturerUtil;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
    ...
    public void openCamera() {
        ...
        try {
            ...
            Camera.Size bestSize = getBestCameraSize(parameters.getSupportedPreviewSizes());
                ...
                ImageUtil.saveToDiskAsync(data, outputPic, new ICallback() {
                    ...
                    public void done(Exception e) {
                        if (e == null) {
                          ...
                          //  ImageUtil.fixOrientation(outputPic.getAbsolutePath());
...
//        }
    ...
    private Camera.Size getBestCameraSize(List<Camera.Size> supportedSizes) {
        Camera.Size bestSize = null;
        List<Camera.Size> sizeList = supportedSizes;
