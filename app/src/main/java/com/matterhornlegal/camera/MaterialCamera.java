...
import com.matterhornlegal.camera.internal.CameraIntentKey;
...
public class MaterialCamera {
    ...
    private boolean startAsResult=false;
    ...
    public MaterialCamera startAsResult(@Nullable boolean startAsResult) {
        this.startAsResult = startAsResult;
        return this;
    }
    ...
    public Intent getIntent() {
        ...
        Intent intent = new Intent(mContext, cls)
                ...
                .putExtra(CameraIntentKey.START_AS_RESULT, startAsResult)
