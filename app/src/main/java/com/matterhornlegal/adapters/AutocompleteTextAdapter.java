...
/**
 * Created by gaurav.singh on 5/3/2018.
 */
...
public class AutocompleteTextAdapter extends ArrayAdapter {
    ...
    public AutocompleteTextAdapter(Context context, int itemLayout, List<String> dataList) {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        NMGTextView textView = (NMGTextView) view.findViewById(R.id.txt_autocomplete);
