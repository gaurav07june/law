...
public class CircleIndicator extends LinearLayout {
    ...
    public void setViewPager(ViewPager viewPager,int loop) {
        ...
        if (mViewpager != null && mViewpager.getAdapter() != null) {
            ...
            mInternalPageChangeListener.onPageSelected(mViewpager.getCurrentItem()-mLoop/2);
        }
    }
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        @Override public void onPageSelected(int position) {
            ...
            if (mViewpager.getAdapter() == null || mViewpager.getAdapter().getCount()-mLoop <= 0) {
                return;
            }
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        @Override public void onChanged() {
            ...
            int newCount = mViewpager.getAdapter().getCount()-mLoop;
            int currentCount = getChildCount();

            if (newCount == currentCount) {  // No change
                return;
            } else if (mLastPosition < newCount) {
                mLastPosition = mViewpager.getCurrentItem()-mLoop/2;
            } else {
                mLastPosition = -1;
            }
    ...
    private void createIndicators() {
        removeAllViews();
        int count = mViewpager.getAdapter().getCount()-mLoop;
        if (count <= 0) {
            return;
        }
        int currentItem = mViewpager.getCurrentItem()-mLoop/2;
