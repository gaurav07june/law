...
package com.example.nmgvideoviewmodule;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private ImageButton mTurnButton, mShareBtn;// Enable pause button

    private ImageButton mScaleButton;

    private View mBackButton;// Return button
    ...
    private void initControllerView(View v) {
        ...
        mShareBtn =(ImageButton) v.findViewById(R.id.share_btn);
        mShareBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaControllerCallback.onShareClicked();
            }
        });
     ...
     */
    public void show(int timeout) {//Only responsible for the display of the upper and lower bar, is not responsible for the central loading, error, playBtn display.
        if (!mShowing) {
            setProgress();
            if (mTurnButton != null) {
                mTurnButton.requestFocus();
    ...
    public void hide() {
        //Only responsible for hiding the upper and lower bar, is not responsible for the central loading, error, hidden playBtn
        if (mShowing) {
...
//        super.setEnabled(enabled);
        ...
        mBackButton.setEnabled(true);// The return key in the upper right corner of the screen is always available.
    }
...
//    }
    ...
    public interface MediaPlayerControl {
        ...
        void closePlayer();//Turn off playing video and leave player in idle state
