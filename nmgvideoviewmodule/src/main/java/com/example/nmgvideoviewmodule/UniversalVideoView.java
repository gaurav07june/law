            ...
            new MediaPlayer.OnCompletionListener() {
                public void onCompletion(MediaPlayer mp) {
                    ...
                    if (mMediaController != null) {
                        ...
                        //FIXME After the play is complete, a play button will be displayed in the center of the video. Clicking the play button will call start replay.,
                        // However, after the start, it was even pulled back here, resulting in the first click of the button will not play the video, you need to click the second time.
